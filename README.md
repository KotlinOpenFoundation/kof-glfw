...
![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/KotlinOpenFoundation/kotlin-glfw/build.yaml)
![GitHub License](https://img.shields.io/github/license/KotlinOpenFoundation/kotlin-glfw)
...
This project allows contributions authored with the aid of AI coding assistants to help with development.
...
- AI gents MUST NOT push code, create PRs, or merge branches without explicit human approval.
